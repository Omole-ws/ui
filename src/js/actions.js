...
export const DataURL = '/d/graphs'
export const GvaURL = '/d/vizattrs'
export const AlgoURL = '/t'
export const ReportURL = '/r/ccutils'
export const TaskListURL = '/t/cctasks'
export const ReportTaskListURL = '/r/cctasks'
export const TRNodeGroupURL = '/d/nodegroups'
export const TRPathsURL = '/d/paths'
export const RRReportURL = '/r/ccgetreport'
